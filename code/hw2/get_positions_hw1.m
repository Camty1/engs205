...
writematrix([(0:length(x_out)-1)', x_out, y_out], "problem_definition/sample_points_hw1.nod", 'FileType', 'text');

writematrix(x_mesh, "x_mesh_hw1.mat", 'FileType', 'text');
writematrix(y_mesh, "y_mesh_hw1.mat", 'FileType', 'text');
writematrix(mask, "mask_hw1.mat", 'FileType', 'text');
