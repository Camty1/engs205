...
template <typename T> Array2D<T> Array2D<T>::operator-() const {
...
template <typename T> void Array2D<T>::fill(const T &value) {
...
template <typename T>
void Array2D<T>::insert(const Array2D<T> &source, size_t sourceStartRow,
                        size_t sourceStartCol, size_t subsetRows,
                        size_t subsetCols, size_t targetStartRow,
                        size_t targetStartCol) {
...
template <typename T> std::vector<T> Array2D<T>::getRowVec(size_t row) const {
...
template <typename T> std::vector<T> Array2D<T>::getColVec(size_t col) const {
